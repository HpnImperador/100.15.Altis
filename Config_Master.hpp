...
/* System Settings */
    ...
    vehicle_purchase_multiplier_DONOR1 = .9; //Civilian Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_DONOR2 = .8; //Civilian Vehicle Buy Price = Config_Vehicle price * multiplier
    vehicle_purchase_multiplier_DONOR3 = .7; //Civilian Vehicle Buy Price = Config_Vehicle price * multiplier
