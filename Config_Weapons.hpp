...
class WeaponShops {
    ...
    class donator1 {
        ...
        side = "civ";
        license = "";
        level[] = { "life_donorlevel", "SCALAR", 1, "You must be a donator!" };
        items[] = {
        	{ "hgun_Rook40_F", "", 13000 },
		    { "hgun_ACPC2_F", "", 20500 },
    ...
    class donator2 {
        ...
        side = "civ";
        license = "";
        level[] = { "life_donorlevel", "SCALAR", 2, "You must be a level 2 donator!" };
        items[] = {
    ...
    class donator3 {
        ...
        side = "civ";
        license = "";
        level[] = { "life_donorlevel", "SCALAR", 3, "You must be a level 3 donator!" };
        items[] = {
        	{ "hgun_Rook40_F", "", 9000 },
		    { "hgun_ACPC2_F", "", 10500 },
			{ "hgun_PDW2000_F", "", 50000 },
